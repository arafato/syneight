...
#ifndef SYNEIGHT__TEST__MAZEGAME__OBJECT__WRONG_DIRECTION_EXCEPTION_HPP
#define SYNEIGHT__TEST__MAZEGAME__OBJECT__WRONG_DIRECTION_TYPE_EXCEPTION_HPP
...
class Wrong_Direction_Exception 
	: public Standard_Mazegame_Exception
{
public:
	virtual ~Wrong_Direction_Exception() SYNEIGHT__EXCEPTION_NO_THROW;
	Wrong_Direction_Exception(::syneight::Source_Location const & source_location,
